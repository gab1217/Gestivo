...
const WINDOWS_DOWNLOAD = "https://github.com/gab1217/Gestivo/releases/download/desktop-v1.0.4/Gestivo-Setup-v1.0.4.exe";
const CONNECTIONS = [
  ...
  if (view === "home") {
    return (
      <main className="site home-site" id="top">
        ...
        <section className="about-section" id="about"><div className="shell about-grid"><div><p className="eyebrow"><span /> Built for inclusion</p><h2>Communication should not depend on who can hear or speak.</h2></div><div className="feature-grid"><article><strong>26</strong><span>FSL alphabet classes</span></article><article><strong>2</strong><span>AI models working together</span></article><article><strong>0</strong><span>Camera frames uploaded</span></article><article><strong>3</strong><span>Ways to use Gestivo</span></article></div><div className="team-card"><div><p className="eyebrow"><span /> Project team</p><h3>The researchers and developers behind Gestivo</h3></div><div className="team-members"><article className="team-lead"><strong>Yousef Gabriel Solizar</strong><span>Group Leader · Application Developer</span></article><article><strong>Adelfa A. Momo</strong><span>Research Team Member</span></article><article><strong>Czarina Leigh B. Plecerda</strong><span>Research Team Member</span></article><article><strong>Jazzy D. Ponteras</strong><span>Research Team Member</span></article><article><strong>John Manuel S. Cortes</strong><span>Research Team Member</span></article><article><strong>Kyle Rio R. Rafanan</strong><span>Group Member</span></article></div></div></div></section>
